...
namespace Components.Aphid.UnitTests
{
    ...
    public class IndexTests : AphidTests
    {
        ...
        [Test]
        public void TestArrayIndexGet2() => ArrayAssertEquals<byte>(0, 0x2, "ret a[0x1]");

        [Test]
        public void TestArrayIndexGet3() => ArrayAssertEquals<byte>(0, 0x10, "ret a[0xf]");

        [Test]
        public void TestArrayIndexGet4() => ArrayAssertEquals<string>(null, 0x10, "ret a[0x0]");

        [Test]
        public void TestArrayIndexGet5() => ArrayAssertEquals<string>(null, 0x10, "ret a[0xf]");

        [Test]
        public void TestArrayIndexSetGet() => ArrayAssert9<byte>(0x1, "a[0x0] = 0x9; ret a[0x0]");

        [Test]
        public void TestArrayIndexSetGet2() => ArrayAssert9<byte>(0x2, "a[0x0] = 0x9; ret a[0x0]");

        [Test]
        public void TestArrayIndexSetGet3() => ArrayAssert9<byte>(0x2, "a[0x1] = 0x9; ret a[0x1]");

        [Test]
        public void TestArrayIndexSetGet4() => ArrayAssert9<byte>(0x100000, "a[0xfffff] = 0x9; ret a[0xfffff]");

        [Test]
        public void TestArrayIndexSetGet5() => ArrayAssert9<byte>(0x100000, "a[0x100000-0x1] = 0x9; ret a[0xfffff]");

        [Test]
        public void TestArrayIndexSetGet6() => ArrayAssert9<byte>(0x100000, "a[0xfffff] = 0x9; ret a[0x100000-0x1]");

        [Test]
        public void TestArrayIndexSetGet7() => ArrayAssert9<byte>(0x100000, "a[0x100000-0x1] = 0x9; ret a[0x100000-0x1]");

        [Test]
        public void TestArrayIndexSetGet8() => ArrayAssertFoo<string>(0x1, "a[0x0] = 'foo'; ret a[0x0]");
        ...
        [Test]
        public void TestArrayOutOfBounds2() => ArrayAssert9<byte>(0x1, "try { a[0x1] } catch { ret 9 } ret 0");

        [Test]
        public void TestArrayOutOfBounds3() => ArrayAssert9<byte>(0x100, "try { a[0x101] } catch { ret 9 }  ret 0");

        [Test]
        public void TestArrayTypeCoercion() => ArrayAssert9<byte>(0x1, "try { a[0x0] = 0xff } catch { ret 0 }  ret 9");

        [Test]
        public void TestArrayTypeCoercion2() => ArrayAssert9<ushort>(0x1, "try { a[0x0] = 0xffff } catch { ret 0 }  ret 9");

        [Test]
        public void TestArrayTypeCoercion3() => ArrayAssert9<uint>(0x1, "try { a[0x0] = 0xffffffff } catch { ret 0 }  ret 9");

        [Test]
        public void TestArrayTypeCoercion4() => ArrayAssert9<ulong>(0x1, "try { a[0x0] = 0xffffffffffffffff } catch { ret 0 }  ret 9");

        [Test]
        public void TestArrayTypeCoercion5() => ArrayAssert9<byte>(0x1, "try { a[0x0] = 0x100 } catch { ret 9 }  ret 0");

        [Test]
        public void TestArrayTypeCoercion6() => ArrayAssert9<ushort>(0x1, "try { a[0x0] = 0x10000 } catch { ret 9 }  ret 0");

        [Test]
        public void TestArrayTypeCoercion7() => ArrayAssert9<uint>(0x1, "try { a[0x0] = 0x100000000 } catch { ret 9 }  ret 0");
