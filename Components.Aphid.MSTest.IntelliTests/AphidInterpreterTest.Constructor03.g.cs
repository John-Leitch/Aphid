...
// <copyright file="AphidInterpreterTest.Constructor03.g.cs">Copyright © AutoSec Tools LLC 2019</copyright>
// <auto-generated>
...
public void Constructor03723()
{
    object o;
    AphidInterpreter aphidInterpreter;
    o = AphidObjectFactory.Create(0);
    aphidInterpreter = this.Constructor03((AphidObject)o, false);
    ...
    Assert.AreEqual<bool>(true, aphidInterpreter.InitialScope.IsScalar);
    Assert.AreEqual<bool>(false, aphidInterpreter.InitialScope.IsComplex);
    Assert.AreEqual<bool>(true, aphidInterpreter.InitialScope.IsComplexitySet);
    Assert.IsNotNull(aphidInterpreter.InitialScope.Value);
    ...
    Assert.IsNull(aphidInterpreter.Loader);
    ...
    Assert.IsNotNull(o);
    Assert.IsTrue(object.ReferenceEquals(o, aphidInterpreter.InitialScope));
}

[TestMethod]
[PexGeneratedBy(typeof(AphidInterpreterTest))]
public void Constructor03255()
{
    object o;
    AphidInterpreter aphidInterpreter;
    o = AphidObjectFactory.Create(0);
    aphidInterpreter = this.Constructor03((AphidObject)o, true);
    Assert.IsNotNull((object)aphidInterpreter);
    Assert.IsNull(aphidInterpreter.OnInterpretBlock);
    Assert.AreEqual<bool>(false, aphidInterpreter.OnInterpretBlockExecuting);
    Assert.IsNull(aphidInterpreter.OnInterpretStatement);
...
public void Constructor03124()
{
    ...
    Assert.IsNotNull(aphidInterpreter.InitialScope.Parent);
    Assert.AreEqual<bool>(false, aphidInterpreter.InitialScope.Parent.IsScalar);
    Assert.AreEqual<bool>(true, aphidInterpreter.InitialScope.Parent.IsComplex);
    Assert.AreEqual<bool>
        (true, aphidInterpreter.InitialScope.Parent.IsComplexitySet);
    Assert.IsNull(aphidInterpreter.InitialScope.Parent.Value);
    Assert.IsNull(aphidInterpreter.InitialScope.Parent.Parent);
    Assert.IsNotNull(aphidInterpreter.InitialScope.Parent.Comparer);
    Assert.AreEqual<int>(0, aphidInterpreter.InitialScope.Parent.Count);
    Assert.IsNotNull(aphidInterpreter.InitialScope.Comparer);
    Assert.IsTrue(object.ReferenceEquals(aphidInterpreter.InitialScope.Comparer, 
                                         aphidInterpreter.InitialScope.Parent.Comparer));
    Assert.AreEqual<int>(5, aphidInterpreter.InitialScope.Count);
    Assert.IsNotNull(aphidInterpreter.CurrentScope);
    Assert.IsTrue(object.ReferenceEquals
                      (aphidInterpreter.CurrentScope, aphidInterpreter.InitialScope));
...
public void Constructor03493()
{
    ...
    Assert.IsNull(aphidInterpreter.InitialScope.Parent);
    Assert.IsNotNull(aphidInterpreter.InitialScope.Comparer);
    Assert.AreEqual<int>(8, aphidInterpreter.InitialScope.Count);
    Assert.IsNotNull(aphidInterpreter.CurrentScope);
    Assert.IsTrue(object.ReferenceEquals
                      (aphidInterpreter.CurrentScope, aphidInterpreter.InitialScope));
    Assert.IsNull(aphidInterpreter.PreviousScope);
