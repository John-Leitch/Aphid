...
namespace Components.Aphid.Debugging
{
    ...
    {
        private static readonly ArgLockingMemoizer<string, (BinaryWriter, BinaryWriter)> _writerMemoizer = new();

        private readonly List<string> _names = new(0x1000);
        ...
        private readonly Stack<Stopwatch> _frames = new(0x100);
