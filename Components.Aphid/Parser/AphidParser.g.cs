namespace Components.Aphid.Parser
{
    ...
    public partial class AphidParser
    {
        ...
        private AphidExpression ParseAssignmentExpression()
        {
            ...
            if ((operand.Index < 0))
            {
                operand.Index = index0012;
                operand.Length = (_currentToken.Index - index0012);
            }
            for (
        ...
        private AphidExpression ParseConditionalExpression()
        {
            ...
            if ((_currentToken.TokenType == AphidTokenType.ConditionalOperator))
            {
                ...
                {
                    trueExpression.Index = index0017;
                    trueExpression.Length = (_currentToken.Index - index0017);
                }
                ...
                {
                    falseExpression.Index = index0018;
                    falseExpression.Length = (_currentToken.Index - index0018);
                }
        ...
        private AphidExpression ParsePostfixUnaryOperationExpression()
        {
            ...
            if ((term.Index < 0))
            {
                term.Index = index001B;
                term.Length = (_currentToken.Index - index001B);
            }
        ...
        private AphidExpression ParseArrayAccessExpression()
        {
            ...
            {
                exp.Index = index0022;
                exp.Length = (_currentToken.Index - index0022);
            }
            for (
            ...
            )
            {
                ...
                {
                    key.Index = index0023;
                    key.Length = (_currentToken.Index - index0023);
                }
        ...
        private AphidExpression ParseCallExpression()
        {
            ...
            if ((function.Index < 0))
            {
                function.Index = index0024;
                function.Length = (_currentToken.Index - index0024);
            }
            for (
        ...
        private AphidExpression ParseMemberExpression()
        {
            ...
            if ((factor.Index < 0))
            {
                factor.Index = index0025;
                factor.Length = (_currentToken.Index - index0025);
            }
            for (
        ...
        private AphidExpression ParseCondition()
        {
            ...
            {
                condition.Index = index0028;
                condition.Length = (_currentToken.Index - index0028);
            }
            Match(AphidTokenType.RightParenthesis);
            return condition;
        }
        ...
        private AphidExpression ParseIfExpression()
        {
            ...
            if ((condition.Index < 0))
            {
                condition.Index = index0029;
                condition.Length = (_currentToken.Index - index0029);
            }
            var body = ParseBlock();
        ...
        private AphidExpression ParseForExpression()
        {
            ...
            {
                initOrElement.Index = index002A;
                initOrElement.Length = (_currentToken.Index - index002A);
            }
            if ((_currentToken.TokenType == AphidTokenType.inKeyword))
            {
                ...
                {
                    collection.Index = index002B;
                    collection.Length = (_currentToken.Index - index002B);
                }
                Match(AphidTokenType.RightParenthesis);
                var body = ParseBlock();
            ...
            else
            {
                ...
                {
                    afterthought.Index = index002D;
                    afterthought.Length = (_currentToken.Index - index002D);
                }
                Match(AphidTokenType.RightParenthesis);
                var body = ParseBlock();
        ...
        private AphidExpression ParseTryExpression()
        {
            ...
            if ((_currentToken.TokenType == AphidTokenType.catchKeyword))
            {
                ...
                if ((catchArg.Index < 0))
                {
                    catchArg.Index = index002F;
                    catchArg.Length = (_currentToken.Index - index002F);
                }
                Match(AphidTokenType.RightParenthesis);
        ...
        private AphidExpression ParsePatternMatchingExpression()
        {
            ...
            if ((testExp.Index < 0))
            {
                testExp.Index = index0034;
                testExp.Length = (_currentToken.Index - index0034);
            }
            Match(AphidTokenType.RightParenthesis);
            for (
            ; true;
            )
            {
                ...
                if ((_currentToken.TokenType == AphidTokenType.ColonOperator))
                {
                    ...
                    if ((valueExp.Index < 0))
                    {
                        valueExp.Index = index0035;
                        valueExp.Length = (_currentToken.Index - index0035);
                    }
        ...
        {
            var t = new TextExpression(_currentToken.Lexeme);
            NextToken();
            return t;
        }
    }
